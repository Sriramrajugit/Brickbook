      ...
      <div className="w-64 bg-white shadow-lg">
        <div className="p-6">
          ...
          <nav className="mt-6">
            ...
            <a href="/employees" className="block px-6 py-3 text-gray-700 hover:bg-gray-200 bg-gray-100">
              Employees
            </a>
            <a
              href="/transactions"
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {employees.map((employee) => (
                      <tr key={employee.id}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{employee.salary ? `$${employee.salary.toFixed(2)}` : 'N/A'}</td>
