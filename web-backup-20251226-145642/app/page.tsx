            ...
            <div className="px-4 py-6 sm:px-0">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="bg-white p-6 rounded-lg shadow">
                  ...
                  <p className="text-3xl font-bold text-blue-600 mt-2">${totalIncome.toFixed(2)}</p>
                </div>
                <div className="bg-white p-6 rounded-lg shadow">
                      ...
                      <div key={account.id} className="bg-white p-6 rounded-lg shadow">
                        ...
                        <div className="grid grid-cols-3 gap-4">
                          <div>
                            ...
                            <p className="text-2xl font-bold text-gray-900 mt-1">${account.balance.toFixed(2)}</p>
                          </div>
                          <div>
                            <p className="text-xs font-medium text-gray-500 uppercase">Income</p>
                            <p className="text-2xl font-bold text-blue-600 mt-1">${summary.income.toFixed(2)}</p>
                          </div>
                          <div>
